...
from app.models import Order, OrderStatus, UserGroupEnum, User, Movie, OrderItem
...
class OrderService:
    ...
    async def place_order(self, current_user: User, movie_ids: list[int]) -> Order:
        movies = (await self._session.scalars(
        ...
        try:
            ...
            print(f"ERRROORRRRRRRRRRRRRRRRRRRRRRR{e}")
    ...
    async def get_history(self, current_user):
        query = (
            select(Order)
